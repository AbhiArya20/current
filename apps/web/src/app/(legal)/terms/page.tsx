  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-auto bg-white dark:bg-[#111111]">
      ...
      <div className="relative z-10 flex grow flex-col">
        {/* Back Button */}
        <div className="fixed right-4 top-6 md:left-8 md:right-auto md:top-8">
          <Link href="/">
            <Button
              variant="ghost"
              size="sm"
              className="gap-2 text-gray-600 hover:text-gray-900 dark:text-white dark:hover:text-white/80 cursor-pointer"
            >
...
const sections = [
  {
    ...
    content: (
      <p>
        0.email is an open-source email solution that enables users to self-host
        their email service or integrate with external email providers. By using
        0.email, you agree to these terms.
      </p>
    ),
  },
  {
      ...
      <div className="space-y-8">
        <div>
          ...
          <ul className="ml-4 list-disc space-y-2">
            <li>
              0.email provides software that users can deploy on their own
              infrastructure
            </li>
            <li>
