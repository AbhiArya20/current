...
import { Card, CardHeader, CardTitle } from "@current/ui/components/card";
...
const LAST_UPDATED = "Aug 30, 2025";
  ...
  return (
    <div className="relative flex w-full flex-col">
      ...
      <div className="relative z-10 flex grow flex-col">
        <div className="fixed right-4 top-6 lg:left-6 lg:right-auto lg:top-10">
          <Link href="/">
            <Button
              variant="ghost"
              size="sm"
        ...
        <div className="container mx-auto max-w-4xl px-4 py-16 pt-24">
...
const sections = [
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          At Current, we believe that privacy is a fundamental right. Our
          open-source software solution is built with privacy at its core, and
          we&apos;re committed to being transparent about how we handle your
          data.
        </p>
        <p className="font-semibold">
          Important: Current is a client-only email application. We DO NOT store
          your emails on our servers. All email data is processed directly
          between your browser and Gmail.
        </p>
        <p>Our verified privacy commitments:</p>
        <ul className="ml-4 list-disc space-y-2">
          <li>
            Zero Email Storage: We never store your emails - they remain in your
            Gmail account
          </li>
          <li>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul className="ml-4 list-disc space-y-2">
          <li>
            We request access to your Gmail data only after receiving your
            explicit consent
          </li>
          <li>
            We access only the necessary Gmail API scopes required for email
            functionality
          </li>
    ...
    content: (
      <div className="space-y-6">
        <div>
          ...
          <ul className="ml-4 list-disc space-y-2">
            <li>
              Email data is processed in accordance with Google API Services
              User Data Policy
            </li>
            <li>
              We only process and display email data - we don&apos;t store
            ...
            <li>
              We maintain limited temporary caches only as necessary for
              application functionality, with a maximum retention period of 24
              hours
            </li>
            ...
            <li>
              Error logs are retained for 30 days to help diagnose and fix
              issues
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul className="ml-4 list-disc space-y-2">
            <li>
              When you self-host Zero, your email data remains entirely under
              your control
            </li>
            <li>
              No data is sent to our servers or third parties without your
              explicit consent
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="ml-4 list-disc space-y-2">
            <li>
              All data processing occurs in secure data centers in the United
              States
            </li>
            <li>
              Self-hosted instances can choose their own data processing
              location
            </li>
    ...
    content: (
      <div className="space-y-6">
        <div>
          ...
          <ul className="ml-4 list-disc space-y-2">
            <li>
              End-to-end encryption for all email communications using
              industry-standard protocols
            </li>
            <li>
              Secure OAuth 2.0 authentication for Google services with strict
              scope limitations
            </li>
            <li>Regular third-party security audits and penetration testing</li>
            <li>
              Open-source codebase for transparency and community security
              review
            </li>
            <li>
            ...
            <li>
              Real-time monitoring for suspicious activities and potential
              security threats
            </li>
      ...
      <div className="space-y-6">
        <div>
          ...
          <ul className="ml-4 list-disc space-y-2">
            ...
            <li>
              This data is used exclusively for providing email functionality
              within Zero
            </li>
            <li>
              No Google user data is used for advertising, marketing, or
              profiling purposes
            </li>
            <li>
              We maintain detailed audit logs of all data access for security
              and compliance
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="ml-4 list-disc space-y-2">
            <li>
              Google user data is never shared with third parties except as
              required for core service functionality
            </li>
            <li>
              When necessary, we only work with service providers who comply
              with Google API Services User Data Policy
            </li>
            <li>
            ...
            <li>
              We maintain a current list of all third-party service providers
              with access to Google user data
            </li>
    ...
    content: (
      <div className="space-y-6">
        <div>
          ...
          <ul className="ml-4 list-disc space-y-2">
            <li>
              Zero offers a free plan with basic features that requires no
              payment information
            </li>
            ...
            <li>
              During the trial period, you have full access to all premium
              features
            </li>
            <li>
              You can cancel at any time during the trial period without any
              charges
            </li>
            <li>
              If you don&apos;t cancel before the trial ends, you&apos;ll be
              automatically charged for the premium subscription
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul className="ml-4 list-disc space-y-2">
            <li>
              After the 7-day free trial period ends, subscription charges will
              begin automatically
            </li>
            <li>
            ...
            <li>
              Subscription charges will appear on your billing statement as
              &quot;Zero Email&quot;
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="ml-4 list-disc space-y-2">
            <li className="font-semibold">
              Important: All subscription fees are non-refundable once the 7-day
              free trial period has ended
            </li>
            <li>
              This policy applies to all premium subscription plans (monthly,
        ...
        <div>
          ...
          <ul className="ml-4 list-disc space-y-2">
            ...
            <li>
              Reactivation of cancelled subscriptions may be subject to current
              pricing
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul className="ml-4 list-disc space-y-2">
            ...
            <li>
              Existing subscribers will be notified of price changes at least 30
              days in advance
            </li>
